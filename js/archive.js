...
const INTERVIEW_FILES = [
  ...
  'grok-4-20-run-7.json',
  'grok-4-20-run-8.json',
  'grok-4-20-run-9.json',
  'grok-4-20-run-10.json',
  'grok-4-20-run-11.json',
  'grok-4-20-run-12.json',
  'grok-4-20-run-13.json',
  'grok-4-20-run-14.json',
  // 'opus-4-7-run-3.json',
  // 'gpt-4o-run-1.json',
];
